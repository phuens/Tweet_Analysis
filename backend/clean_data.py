...
def main():
	...
	entries = os.listdir('./CSVdata/raw_data')
	for entries in entries: 
		if entries != ".DS_Store":
			# Read the file from raw_data folder and write in cleaned_data folder
			input_file = "./CSVdata/raw_data/"+entries
			with open(input_file) as csv_file:
				csv_reader = csv.reader(csv_file, delimiter=',')

				output_file = "./CSVdata/cleaned_data/"+entries
				with open(output_file,'w') as clean_csv:
		...
		print("--------------------------------------------------------------------------------")
		print("################################################################################")
		print("DONE WITH: {}".format(entries))
		print("################################################################################")
		print("--------------------------------------------------------------------------------")				
